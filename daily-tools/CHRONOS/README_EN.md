...
git clone https://github.com/yuta-ishikawa-bio/nexus-focus.git
cd nexus-focus
...
The UI turned out so good that I kept staring at it instead of studying.  
If you find yourself unable to focus, that's not a willpower problem — that's a UI problem.
